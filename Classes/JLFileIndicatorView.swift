...
open class JLFileIndicatorView: UIView {
    ...
    */
    ...
    @objc func target(_ tapGes:UITapGestureRecognizer){
    ...
    @objc func removeFileButtonAction(_ sender:AnyObject?){
    ...
    private func initRemoveFileButton(){
        ...
        removeFileButton.setTitle("x", for: [])
        
        removeFileButton.tintColor = UIColor.gray
        
        removeFileButton.setTitleColor(UIColor.gray, for: [])
