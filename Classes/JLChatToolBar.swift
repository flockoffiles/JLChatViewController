...
open class JLChatToolBar: UIToolbar, UITextViewDelegate, FileDelegate {
    ...
    override open var frame:CGRect{
        didSet{
            toolBarFrameDelegate?.haveToUpdateInsetsBottom(bottom: keyBoadHeight + self.frame.height,scrollToBottom: false)
        }
    }
    ...
    override open func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        ...
        if keyPath == "center"{
            ...
            toolBarFrameDelegate?.haveToUpdateInsetsBottom(bottom: keyBoadHeight + self.frame.height,scrollToBottom: lastToolBarHeight < self.frame.height)
    ...
    */
    open func configToolInputText(font:UIFont,textColor:UIColor?,placeHolder:String?){
    ...
    */
    open func configLeftButton(title:String?,image:UIImage?){
        
        self.leftButton.setTitle(title, for: UIControlState.normal)
        
        self.leftButton.setImage(image, for: UIControlState.normal)
    ...
    /**
     ...
     - parameter image: the image of the button
     */
    open func configRightButton(title:String?,image:UIImage?){
        
        self.rightButton.setTitle(title, for: UIControlState.normal)
    ...
    @objc func rightButtonAction(_ sender:AnyObject?){
    ...
    */
    ...
    @objc func showkeyBoardTarget(_ notification:NSNotification){
        ...
        toolBarFrameDelegate?.haveToUpdateInsetsBottom(bottom: keyBoadHeight + self.frame.height,scrollToBottom: true)
    ...
    private func initLeftButton(){
        ...
        leftButton.setTitle("File", for: UIControlState.normal)
    ...
    private func initRightButton(){
        ...
        rightButton.setTitle("Send", for: UIControlState.normal)
